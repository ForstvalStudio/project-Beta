...
from agents.column_mapper import column_mapper
...
app = FastAPI(title="Project Beta Sidecar")
...
async def startup_event():
    ...
    # 2. Initialize LanceDB and seed UI fields
    ...
    try:
        while True:
            ...
            if msg_type == "ping":
                ...
                try:
                    # check if model exists, if not, use mock for demo
                    ...
                    if os.path.exists(model_path):
                        ...
                        mock_mappings = []
                        for h in headers:
                            mock_mappings.append(MappingEntry(
                                workbook_col=h,
                    ...
                    result = mapping_manager.process_ai_response(ai_response)
...
if __name__ == "__main__":
    # Get port from env if provided (Tauri can pass this)
